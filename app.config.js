...
export default {
  expo: {
    ...
    ios: {
      supportsTablet: true,
      bundleIdentifier: "com.nuralix.app",
      buildNumber: "42",
      ...
      infoPlist: {
        NSCameraUsageDescription:
          "Nuralix uses the camera to allow you to take profile photos, scan medication barcodes, and measure heart rate using PPG (photoplethysmography) for vital signs monitoring.",
        NSPhotoLibraryUsageDescription:
          "Nuralix needs access to your photo library to select profile pictures and save health-related images.",
        NSMotionUsageDescription:
          "Nuralix uses motion sensors to detect falls and automatically alert your emergency contacts for your safety.",
        NSLocationWhenInUseUsageDescription:
          "Nuralix uses your location to share with emergency contacts during fall detection alerts, ensuring help can reach you quickly.",
        NSHealthShareUsageDescription:
          "Nuralix reads health data to provide personalized health insights, track your wellness progress, and help you manage your medications effectively.",
        NSHealthUpdateUsageDescription:
          "Nuralix writes health data to keep your health information synchronized across all your devices and maintain accurate health records.",
        NSUserTrackingUsageDescription:
          "Nuralix uses tracking to provide personalized health insights and recommendations. This helps us improve your health tracking experience and deliver relevant health information. Your health data remains secure and is never sold to third parties.",
        NSFaceIDUsageDescription:
          "Nuralix uses Face ID or Touch ID to securely authenticate your identity for biometric authentication.",
        NSMicrophoneUsageDescription:
          "Nuralix needs access to your microphone to use voice features with Nora, your health assistant.",
        ITSAppUsesNonExemptEncryption: false,
        UIBackgroundModes: ["processing"],
        BGTaskSchedulerPermittedIdentifiers: [
          "com.nuralix.app.background-task",
        ],
