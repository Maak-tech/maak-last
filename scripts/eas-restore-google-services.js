...
console.log('🔧 Restoring Google Services files from EAS environment variables...');
...
if (process.env.GOOGLE_SERVICES_JSON) {
  ...
  console.log('⚠️  Warning: GOOGLE_SERVICES_JSON environment variable is not set');
}
...
if (process.env.GOOGLE_SERVICE_INFO_PLIST) {
  ...
  console.log('⚠️  Warning: GOOGLE_SERVICE_INFO_PLIST environment variable is not set');
}
