...
eas secret:create --scope project --name NORA_API_KEY --value "YOUR_VALUE" --type string --visibility secret --environment all
...
- ✅ `NORA_API_KEY` - For Nora voice assistant
