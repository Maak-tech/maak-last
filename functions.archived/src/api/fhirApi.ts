 ...
 * FHIR R4 API
 *
 * Exposes Nuralix health data as HL7 FHIR R4 resources, enabling integration
...
function fhirBaseUrl(req: functions.https.Request): string {
  const host = req.headers.host ?? "nuralix.ai";
...
/**
 * Nuralix FHIR R4 API — single Cloud Function with internal routing.
 *
 * Deploy URL:
