...
/**
 * Nuralix Public API — single Cloud Function with internal routing.
 *
 * Deploy URL:
 *   https://<region>-<project>.cloudfunctions.net/nuralixApi/v1/...
 */
export const nuralixApi = functions.https.onRequest(async (rawReq, res) => {
