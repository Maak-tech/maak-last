 ...
 * - NoraInput: NO PHI (sanitized, normalized)
 * - NoraOutput: NO PHI (structured actions only)
 */
...
/**
 * Nora analysis request
 */
export type NoraAnalysisRequest = {
  traceId: string;
  alertContext: AlertContext;
};

/**
 * Nora analysis result (public API response)
 */
export type NoraAnalysisResult = {
  success: boolean;
  output?: NoraOutput;
  error?: string;
  traceId: string;
...
/**
 * Backend actions (deterministic mapping from NoraOutput)
 */
