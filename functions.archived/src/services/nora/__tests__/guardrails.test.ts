/**
 * Unit tests for Nora guardrails
...
describe("Nora Guardrails", () => {
  ...
  describe("sanitizeToNoraOutput", () => {
    it("should create valid NoraOutput from AI response", () => {
      const response: RawAIResponse = {
        riskScore: 65,
    ...
    it("should truncate too long summary", () => {
      ...
      const output = sanitizeToNoraOutput(response, context, "trace_123");
