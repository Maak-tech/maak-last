/**
 * Nora Analysis Storage
 * Handles persisting Nora analysis results to Firestore
 */
...
export async function enrichAlertWithAnalysis(
  ...
  logger.info("Enriching alert with Nora analysis", {
    traceId,
    alertId,
    riskScore: analysisResult.riskScore,
    fn: "nora.enrichAlertWithAnalysis",
  });

  try {
    const db = getFirestore();

    // Extract values safely to support both NoraOutput and legacy format
