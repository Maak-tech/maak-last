...
<head>
  ...
  <title>Authorize Access — Nuralix</title>
  <style>
...
<body>
  <div class="card">
    <div class="logo">
      ...
      <span class="logo-text">Nuralix</span>
    </div>
 ...
 * Requires a valid Nuralix API key in the Authorization header.
...
async function mintAccessToken(
  ...
  const payload: Record<string, unknown> = {
    iss: "https://nuralix.ai",
    sub: params.sub,
    aud: "https://nuralix.ai/fhir/r4",
    jti,
    iat: now,
