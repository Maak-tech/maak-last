...
import WebNoticeBar from "@/components/WebNoticeBar";
...
export default function PPGMeasureScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      {/* Web notice — camera-based PPG requires native camera API */}
      <WebNoticeBar
        message="Camera-based heart rate measurement requires the Nuralix mobile app. Your synced vitals are visible on web."
        messageAr="قياس معدل ضربات القلب عبر الكاميرا يتطلب تطبيق Nuralix للجوال. بياناتك الحيوية المزامنة مرئية على الويب."
      />
