/**
 * Withings Introduction Screen
 * Pre-permission explanation before requesting Withings OAuth
 */
    ...
    >
      ...
      >
        ...
        <View style={styles.heroSection}>
          ...
          >
            {isRTL
              ? "ميزان ذكي ومراقبة صحية شاملة"
              : "Smart scales and comprehensive health monitoring"}
          </Text>
        </View>
          ...
          <View style={styles.benefitsList}>
            <View style={styles.benefitItem}>
              ...
              <View style={styles.benefitContent}>
                ...
                >
                  {isRTL ? "قياسات دقيقة للجسم" : "Precise Body Measurements"}
                </Text>
                <Text
                  style={[
                ...
                >
                  {isRTL
                    ? "الوزن، نسبة الدهون، مؤشر كتلة الجسم، والمزيد"
                    : "Weight, body fat percentage, BMI, and more"}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.benefitItem}>
              ...
              <View style={styles.benefitContent}>
                ...
                >
                  {isRTL ? "مراقبة القلب والضغط" : "Heart & Blood Pressure"}
                </Text>
                <Text
                  style={[
                    styles.benefitDescription,
            ...
            <View style={styles.privacyItem}>
              ...
              >
                {isRTL
                  ...
                  : "Your data protected with highest security standards"}
              </Text>
            </View>
            <View style={styles.privacyItem}>
        ...
        <View style={styles.connectSection}>
          <TouchableOpacity
            onPress={() => router.push("/profile/health/withings-permissions")}
