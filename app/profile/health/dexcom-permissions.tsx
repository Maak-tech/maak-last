  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        isRTL
          ? "تم ربط Dexcom CGM بنجاح. سيبدأ مزامنة البيانات قريباً."
          : "Dexcom CGM connected successfully. Real-time glucose data sync will begin shortly.",
        [
          {
            text: isRTL ? "موافق" : "OK",
            ...
            {connecting ? (
              ...
              <>
                <Text style={styles.connectButtonText}>
                  {isRTL ? "ربط Dexcom CGM" : "Connect Dexcom CGM"}
                </Text>
                <ChevronRight
                  color="#FFFFFF"
                  size={20}
