    ...
    >
      ...
      {loading ? (
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
          {/* Web notice — hidden on native, shown on web only */}
          <WebNoticeBar />
          {/* Welcome Section */}
          <View
            style={[
          ...
          <View style={styles.providersSection}>
            ...
            >
              <View style={styles.providerIconContainer}>
                <Dna color={theme.colors.primary.main} size={24} />
              </View>
              ...
              <View style={styles.providerContent}>
                <View style={styles.providerHeader}>
                  ...
                  >
                    {isRTL ? "الملف الجيني" : "DNA / Genetic Profile"}
                  </Text>
                </View>
                <Text
                  style={[
                ...
                >
                  {isRTL
                    ? "قم بتحميل بيانات DNA لمعرفة مخاطرك الجينية ونصائح الأدوية الشخصية"
                    : "Upload DNA data to reveal your genetic risks and personalized medication insights"}
                </Text>
              </View>
