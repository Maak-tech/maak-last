 ...
 *
 * Shows org admins and tech leads everything needed to connect Nuralix to
...
const EPIC_STEPS = [
  ...
  "Add Redirect URI: nuralix://auth/fhir-callback",
  `Set FHIR Base URL to: ${FHIR_BASE}`,
  "Select scopes: patient/*.read, user/*.read, launch",
  "Copy Client ID from App Orchard → add to Nuralix API Keys screen",
      ...
      >
        ...
        >
          ...
          >
            ...
            Nuralix. Use your organization API key to authenticate this call:
          </Caption>
          <View
            style={{
              backgroundColor: "#111827",
