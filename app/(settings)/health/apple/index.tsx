    ...
    <SafeAreaView style={styles.container as ViewStyle}>
      ...
      >
        <View style={styles.header as ViewStyle}>
          ...
          >
            {isRTL
              ? "يمكن لـ Nuralix قراءة البيانات الصحية التي تختارها لمساعدتك وعائلتك في تتبع الاتجاهات واكتشاف المخاطر مبكرًا."
              : "Nuralix can read the health data you choose to help you and your family track trends and spot risks early."}
          </Text>
        </View>
        ...
        <View style={styles.section as ViewStyle}>
          ...
          >
            •{" "}
            {isRTL
              ? "وصول للقراءة فقط (Nuralix لا يكتب أبدًا في Apple Health)"
              : "Read-only access (Nuralix never writes to Apple Health)"}
          </Text>
          <Text
            style={
              [
          ...
          >
            •{" "}
            {isRTL
              ? "التغيير في أي وقت (إدارة أو إلغاء في إعدادات iOS)"
              : "Change anytime (manage or revoke in iOS Settings)"}
          </Text>
        </View>
        ...
        <View style={styles.notDoSection as ViewStyle}>
          ...
          >
            •{" "}
            {isRTL
              ? "لن نكتب أو نعدل بيانات Apple Health الخاصة بك"
              : "We will never write to or modify your Apple Health data"}
          </Text>
          <Text
            style={
              [
        ...
        {Boolean(expanded) && (
          ...
          >
            {isRTL
              ? "يستخدم Apple Health HealthKit لتخزين البيانات الصحية بشكل آمن على جهازك. يستخدم Nuralix البيانات التي تختارها لتقديم رؤى الرعاية (مثل الاتجاهات والتنبيهات) ولا نبيع بياناتك الصحية."
              : "Apple Health uses HealthKit to store health data securely on your device. Nuralix uses the data you select to provide caregiving insights (like trends and alerts) and we do not sell your health data."}
          </Text>
        )}
