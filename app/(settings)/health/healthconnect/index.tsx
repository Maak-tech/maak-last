    ...
    <SafeAreaView style={styles.container as ViewStyle}>
      ...
      >
        <View style={styles.header as ViewStyle}>
          ...
          >
            {isRTL
              ? "يمكن لـ Nuralix قراءة البيانات الصحية التي تختارها من Health Connect لمساعدتك وعائلتك في تتبع الاتجاهات واكتشاف المخاطر مبكرًا."
              : "Nuralix can read the health data you choose from Health Connect to help you and your family track trends and spot risks early."}
          </Text>
        </View>
        ...
        <View style={styles.section as ViewStyle}>
          ...
          >
            •{" "}
            {isRTL
              ? "وصول للقراءة فقط (Nuralix لا يكتب أبدًا في Health Connect)"
              : "Read-only access (Nuralix never writes to Health Connect)"}
          </Text>
          <Text
            style={
              [
        ...
        {expanded ? (
          ...
          >
            {isRTL
              ? "يستخدم Health Connect من Google لتخزين البيانات الصحية بشكل آمن على جهازك. يستخدم Nuralix البيانات التي تختارها لتقديم رؤى الرعاية (مثل الاتجاهات والتنبيهات) ولا نبيع بياناتك الصحية."
              : "Health Connect by Google stores health data securely on your device. Nuralix uses the data you select to provide caregiving insights (like trends and alerts) and we do not sell your health data."}
          </Text>
        ) : null}
