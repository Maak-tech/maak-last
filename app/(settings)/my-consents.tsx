          ...
          { text: "Cancel", style: "cancel" },
          {
            ...
            onPress: async () => {
              ...
              try {
                ...
                console.warn('[my-consents] Failed to revoke consent:', err instanceof Error ? err.message : String(err));
                Alert.alert(
                  "Error",
        ...
        {!loading && (
          ...
          >
            <Caption style={{ color: "#003543" }}>
              ...
              Your Nuralix data is never sold or shared without explicit consent.
            </Caption>
          </View>
        )}
      </ScrollView>
