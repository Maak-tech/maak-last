      ...
      {isLoading ? (
        ...
        >
          ...
          >
            ...
            >
              {isRTL
                ? "جميع الخطط المميزة تتضمن نسخاً احتياطية تلقائية، دعماً أولوياً، وتشفيراً كاملاً للبيانات. لأسئلة الفوترة تواصل: support@nuralix.ai"
                : "All premium plans include automatic cloud backup, priority support, and full data encryption. For billing questions contact support@nuralix.ai"}
            </Caption>
          </View>
