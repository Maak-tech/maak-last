    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerSubtitle, isRTL && styles.rtlText]}>
          {isRTL ? 'راقب أعراضك وأدويتك' : 'Monitor your symptoms and medications'}
        </Text>
      </View>
            ...
            <View style={styles.trackingSection}>
              ...
              <View style={styles.trackingOptions}>
                ...
                >
                  <View style={[
                    ...
                    <Activity size={28} color={theme.colors.primary.main} />
                  </View>
                  <Text style={[styles.trackingCardTitle, isRTL && styles.rtlText]}>
                    {isRTL ? 'الأعراض' : 'Symptoms'}
                  </Text>
                  <Text style={[styles.trackingCardSubtitle, isRTL && styles.rtlText]}>
                    {isRTL 
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => router.push('/(tabs)/symptoms')}
                  >
                    <Activity size={16} color={theme.colors.neutral.white} />
                ...
                >
                  <View style={[
                    ...
                    <Pill size={28} color={theme.colors.accent.success} />
                  </View>
                  <Text style={[styles.trackingCardTitle, isRTL && styles.rtlText]}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => router.push('/(tabs)/medications')}
                  >
                    <Pill size={16} color={theme.colors.neutral.white} />
                    <Text style={styles.trackingCardButtonText}>
                      {isRTL ? 'إدارة' : 'Manage'}
                    </Text>
                  </TouchableOpacity>
              ...
              >
                <View style={[
                  ...
                  <Zap size={28} color={theme.colors.secondary.main} />
                </View>
                <Text style={[styles.trackingCardTitle, isRTL && styles.rtlText]}>
                ...
                <TouchableOpacity 
                  style={[styles.trackingCardButton, { backgroundColor: theme.colors.secondary.main }]}
                  onPress={() => router.push('/(tabs)/vitals')}
                >
                  <Heart size={16} color={theme.colors.neutral.white} />
                  <Text style={styles.trackingCardButtonText}>
                    {isRTL ? 'عرض' : 'View'}
                  </Text>
                </TouchableOpacity>
                ...
                {recentSymptoms.slice(0, 3).map((symptom) => (
                  ...
                  >
                    ...
                    <View style={styles.recentInfo}>
                      <Text style={[styles.recentTitle, isRTL && styles.rtlText]}>
                        {t(symptom.type)}
                      </Text>
                      <Text style={[styles.recentSubtitle, isRTL && styles.rtlText]}>
                        {formatTime(symptom.timestamp)} • {isRTL ? 'شدة' : 'Severity'} {symptom.severity}/5
                      </Text>
                    </View>
                  </TouchableOpacity>
                ))}
                ...
                {todaysMedications.slice(0, 3).map((medication) => (
                  ...
                  >
                    <View style={[
                      ...
                      <Pill size={20} color={theme.colors.accent.success} />
                    </View>
                    <View style={styles.recentInfo}>
                      <Text style={[styles.recentTitle, isRTL && styles.rtlText]}>
                        {medication.name}
