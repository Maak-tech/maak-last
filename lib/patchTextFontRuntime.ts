...
const reactWithPatch = React as typeof React & {
  __nuralixArabicCreateElementPatched?: boolean;
  __nuralixOriginalCreateElement?: typeof React.createElement;
};

if (!reactWithPatch.__nuralixArabicCreateElementPatched) {
  reactWithPatch.__nuralixArabicCreateElementPatched = true;
  const originalCreateElement = React.createElement;
  reactWithPatch.__nuralixOriginalCreateElement = originalCreateElement;
