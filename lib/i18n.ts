...
const resources = {
  en: {
    translation: {
      ...
      pleaseCheckCredentials: "Please check your credentials and try again.",
      ...
      willBeAddedToFamily: "You will be added to the family group shortly.",
      notice: "Notice",
      ...
      loadingFamilyInsights: "Loading family insights...",
      noFamilyInsightsAvailable: "No family insights available yet.",
      symptomsIncreasing: "Symptoms ↑",
      symptomsDecreasing: "Symptoms ↓",
      moodImproving: "Mood ↑",
      moodDeclining: "Mood ↓",
      medicationCompliance: "Compliance",
      familyMood: "Mood",
      familyMoodImproving: "Family mood is improving",
      familyMoodDeclining: "Family mood is affected by negative factors",
      symptomsIncreasingAr: "أعراض متزايدة",
      symptomsDecreasingAr: "أعراض متناقصة",
      ...
      medicationsLoaded: "Medications loaded",
      moodsLoaded: "Moods loaded",
      statsCards: "Stats cards",
      recentSymptomsTitle: "Recent symptoms",
      ...
      // Medication alarm modal
      medicationAlarmTitle: "Medication Reminder",
      medicationAlarmSubtitle: "Time to take your medication",
      medicationAlarmBody: "Time to take {{medicationName}}{{dosage}}",
      medicationAlarmTaken: "I took it",
      medicationAlarmSnooze: "Snooze",
      failedToAcknowledgeEvent: "Failed to acknowledge event",
      failedToResolveEvent: "Failed to resolve event",
      failedToEscalateEvent: "Failed to escalate event",
      failedToAddEvent: "Failed to add event",
      failedToLoadEvents: "Failed to load events",
      inviteNewMember: "Invite New Member",
      enterFullName: "Enter full name",
      relationship: "Relationship",
      inviteSomeoneToCareCircle: "Invite someone to your care circle",
      tapToAddFamilyMembers:
        "Tap here to add family members and track their health.",
      trackFamilyHealth: "Track family health",
      ...
      pleaseEnterReminderTimesFormat:
        "Please enter reminder times in correct format (e.g., 8:00)",
      title: "Title",
      eventType: "Event Type",
      // Allergy conflict
      allergyConflictWarning: "⚠️ Warning: Allergy Conflict",
      medicationConflictMessage:
        "This medication may conflict with the following allergies: {{allergies}}",
      severeAllergyWarning:
        "Warning: Some of these allergies are {{severity}}!",
      areYouSureProceed: "Are you sure you want to proceed?",
      proceedAnyway: "Proceed Anyway",
      // Vitals/Health integration
      errorLoadingHealthData: "Error loading health data",
      healthDataIntegrationEnabled:
        "Health data integration enabled successfully",
      permissionDenied: "Permission Denied",
      pleaseAllowHealthDataAccess:
      ...
      healthKitNotAvailable: "HealthKit Not Available",
      healthKitNotAvailableMessage: "HealthKit is not available.",
      ...
      open: "Open",
      healthConnectError: "Health Connect Error",
      enabled: "Enabled",
      permissionError: "Permission Error",
      errorSyncingHealthData: "Error syncing health data",
      // Medical history
      errorLoadingMedicalHistory: "Error loading medical history",
      pleaseEnterMedicalCondition: "Please enter medical condition name",
      pleaseSelectFamilyMember: "Please select a family member",
      medicalRecordAddedSuccessfully: "Medical record added successfully",
      failedToAddMedicalRecord: "Failed to add medical record",
      deleteRecord: "Delete Record",
      confirmDeleteMedicalRecord:
        "Are you sure you want to delete this medical record?",
      deleted: "Deleted",
      medicalRecordDeletedSuccessfully: "Medical record deleted successfully",
      ...
      select: "Select",
      healthDataIntegration: "Health Data Integration",
      setUpIntegration: "Set Up Integration",
      healthVitalsIntegrations: "Health vitals integrations",
      syncHealthVitals: "Sync health vitals",
      failedToDeleteMedicalRecord: "Failed to delete medical record",
      mustBeLoggedInFirst: "You must be logged in first",
      pleaseEnterEventTitle: "Please enter an event title",
      pleaseSelectStartDate: "Please select a start date",
      pleaseSelectValidEndDate: "Please select a valid end date",
      reactNativeBridgeNotReady:
        "React Native bridge is not ready. Please try again in a few seconds or rebuild the app.",
      failedToConnectHealthKit: "Failed to connect to HealthKit.",
      failedToConnectHealthConnect: "Failed to connect to Health Connect.",
      failedToRequestHealthKitPermission:
        "Failed to request HealthKit permission.",
      failedToRequestHealthConnectPermission:
        "Failed to request Health Connect permission.",
      ...
      clinicalIntegrations: "Clinical Integrations",
      clinicIntegration: "Clinics",
      clinicIntegrationDesc:
        "Connect clinic portals for visits, medications, and care plans",
      labIntegration: "Labs",
      labIntegrationDesc: "Import lab results and reference ranges directly",
      radiologyIntegration: "Radiology",
      radiologyIntegrationDesc: "Sync imaging reports and radiology PDFs",
      integrationStatus: "Integration Status",
      integrationStatusNone: "No requests yet",
      integrationStatusPending: "Pending review",
      integrationStatusApproved: "Approved",
      integrationStatusRejected: "Needs more info",
      integrationStatusConnected: "Connected",
      integrationRequestTitle: "Request Integration",
      integrationRequestSubtitle:
        "We'll contact the facility to enable secure data sharing.",
      integrationProviderName: "Provider Name",
      integrationPortalUrl: "Portal URL (optional)",
      integrationPatientId: "Patient ID / MRN (optional)",
      integrationNotes: "Notes (optional)",
      integrationSubmit: "Submit Request",
      integrationSubmittedMessage:
        "We received your request and will follow up with next steps.",
      integrationMissingProviderName: "Please enter a provider name.",
      integrationNotSignedIn:
        "You must be logged in to request an integration.",
      integrationRequestedOn: "Requested on {{date}}",
  ...
  ar: {
    translation: {
      ...
      joinExistingFamily: "الانضمام إلى عائلة موجودة",
      familyCode: "رمز العائلة",
      verificationCode: "رمز التحقق",
      enterVerificationCode: "أدخل رمز التحقق",
      loginSuccessful: "تم تسجيل الدخول بنجاح",
      willBeAddedToFamily: "سيتم إضافتك إلى مجموعة العائلة قريباً.",
      notice: "إشعار",
      familyCodeStorageIssue:
        "حدثت مشكلة في تخزين رمز العائلة. يرجى استخدام رمز العائلة في تبويب العائلة بعد تسجيل الدخول.",
      phone: "رقم الهاتف",
      phoneNumber: "رقم الهاتف",
      enterYourEmail: "أدخل بريدك الإلكتروني",
      enterYourPassword: "أدخل كلمة المرور",
      enterPhoneNumberExample: "مثال: +1234567890 أو +966501234567",
      phoneNumberHelper:
        "أدخل رقم هاتفك مع رمز الدولة (مثال: +1234567890 للولايات المتحدة، +966501234567 للسعودية). سنرسل لك رمز تحقق عبر الرسائل النصية",
      codeSent: "تم إرسال الرمز. أدخله بالأسفل أو أعد الإرسال.",
      enter6DigitCode: "أدخل رمز التحقق المكون من 6 أرقام",
      verifying: "جارٍ التحقق...",
      verify: "تحقق",
      sendVerificationCode: "إرسال رمز التحقق",
      enterInvitationCode: "أدخل رمز الدعوة (6 أرقام)",
      invitationCodeHelper: "أدخل رمز الدعوة المرسل إليك من أحد أفراد العائلة",
      ...
      fallAlerts: "تنبيهات السقوط",
      wellnessCheckins: "تحديثات العافية اليومية",
      medicationReminders: "تذكيرات الأدوية",
      symptomAlerts: "تنبيهات الأعراض",
      familyUpdates: "تحديثات العائلة",
      alertPreferences: "تفضيلات التنبيه",
      sound: "الصوت",
      playSoundWithNotifications: "تشغيل صوت مع الإشعارات",
      vibration: "الاهتزاز",
      ...
      sent: "تم الإرسال",
      notificationsAreEnabled: "الإشعارات مفعلة",
      notificationsAreDisabled: "الإشعارات معطلة",
      immediateNotificationsWhenFallDetected: "إشعارات فورية عند اكتشاف سقوط",
      lightDailyCheckins: "تذكيرات يومية بسيطة لمتابعة الصحة",
      remindersAtMedicationTimes: "تذكيرات في أوقات تناول الأدوية",
      notificationsForSevereSymptoms: "إشعارات عند تسجيل أعراض شديدة",
      notificationsAboutFamilyActivities: "إشعارات حول نشاطات أفراد العائلة",
      vibrateDeviceWithNotifications: "اهتزاز الجهاز مع الإشعارات",
      ...
      notificationsCleared: "تم مسح الإشعارات بنجاح",
      cancelledNotifications: "تم إلغاء {{count}} إشعار",
      cancelledNotificationsPlural: "تم إلغاء {{count}} إشعار",
      failedToClearNotifications: "فشل في مسح الإشعارات",
      testFamilyUpdateSent: "تم إرسال إشعار اختبار للأدمن.",
      failedToSendTestNotification: "فشل إرسال إشعار الاختبار",
      notPermitted: "غير مسموح",
      youDoNotHavePermissionToEditSymptom:
        "ليس لديك صلاحية لتعديل هذه الأعراض الصحية",
      pleaseSelectOrEnterSymptomType: "يرجى اختيار أو إدخال نوع الأعراض الصحية",
      symptomUpdatedSuccessfully: "تم تحديث الأعراض المرضية بنجاح",
      symptomLoggedSuccessfully: "تم تسجيل الأعراض المرضية بنجاح",
      errorSavingSymptom: "حدث خطأ في حفظ الأعراض الصحية",
      deleteSymptom: "حذف الأعراض الصحية",
      areYouSureDeleteSymptom:
        "هل أنت متأكد من رغبتك في حذف هذه الأعراض الصحية: {{type}}؟",
      symptomDeletedSuccessfully: "تم حذف الأعراض الصحية بنجاح",
      errorDeletingSymptom: "حدث خطأ في حذف الأعراض الصحية",
      lessThanAnHourAgo: "منذ أقل من ساعة",
      avgSeverity: "متوسط الشدة",
      you: "أنت",
      recentFamilySymptoms: "أعراض العائلة الصحية الأخيرة",
      myRecentSymptoms: "أعراضي الصحية الأخيرة",
      youDoNotHavePermissionToDeleteSymptom:
        "ليس لديك صلاحية لحذف هذه الأعراض الصحية",
      noSymptomsRecorded: "لا توجد أعراض صحية مسجلة",
      addSymptomFor: "إضافة الأعراض الصحية لـ",
      admin: "مدير",
      commonSymptoms: "الأعراض الصحية الشائعة",
      customSymptom: "أعراض مخصصة صحية",
      enterSymptomType: "أدخل نوع الأعراض الصحية...",
      ...
      memberRecentSymptoms: "أعراض {{name}} الصحية الأخيرة",
      user: "مستخدم",
      ...
      healthInsights: "التحليلات الصحية",
      keyInsights: "ملاحظات مهمة",
      recentSymptoms: "الأعراض الأخيرة",
      upcomingMeds: "الأدوية القادمة",
      familyAlerts: "تنبيهات العائلة",
      familyInsights: "تحليلات العائلة",
      analyzingData: "جاري تحليل البيانات...",
      weekSummary: "ملخص الأسبوع",
      mostCommonSymptoms: "الأعراض الصحية الأكثر شيوعاً",
      viewFullDetails: "عرض التفاصيل الكاملة",
      loadingFamilyInsights: "جاري تحميل التحليلات الصحية للعائلة...",
      noFamilyInsightsAvailable: "لا توجد تحليلات صحية لأفراد العائلة بعد.",
      symptomsIncreasing: "أعراض متزايدة",
      symptomsDecreasing: "أعراض متناقصة",
      moodImproving: "الحالة النفسية للعائلة تتحسن",
      moodDeclining: "الحالة النفسية للعائلة تتأثر بالعوامل السلبية",
      medicationCompliance: "الالتزام بالأدوية",
      familyMood: "الحالة النفسية",
      familyMoodImproving: "الحالة النفسية للعائلة تتحسن",
      familyMoodDeclining: "الحالة النفسية للعائلة تتأثر بالعوامل السلبية",
      symptomsIncreasingAr: "أعراض متزايدة",
      symptomsDecreasingAr: "أعراض متناقصة",
      ...
      eventAcknowledged: "تم تأكيد الحدث",
      ...
      remindMeDays: "ذكرني قبل",
      days: "أيام",
      medicalHistory: "السجل الطبي",
      detailsAvailable: "التفاصيل متاحة",
      loadingSymptoms: "جاري تحميل الأعراض",
      loadingMedications: "جاري تحميل الأدوية",
      loadingMoods: "جاري تحميل المزاج",
      medicationsLoaded: "تم تحميل الأدوية",
      moodsLoaded: "تم تحميل المزاج",
      statsCards: "بطاقات الإحصاءات",
      recentSymptomsTitle: "الأعراض الحديثة",
      quickActions: "إجراءات سريعة",
      navigationTabs: "التنقل بين الأقسام",
      conditions: "الحالات",
      ...
      // Medication alarm modal
      medicationAlarmTitle: "تذكير بالأدوية",
      medicationAlarmSubtitle: "حان وقت تناول دوائك",
      medicationAlarmBody: "حان وقت تناول {{medicationName}}{{dosage}}",
      medicationAlarmTaken: "تناولته",
      medicationAlarmSnooze: "تأجيل",
      failedToAcknowledgeEvent: "فشل في تأكيد الحدث",
      failedToResolveEvent: "فشل في حل الحدث",
      failedToEscalateEvent: "فشل في تصعيد الحدث",
      failedToAddEvent: "فشل في إضافة الحدث",
      failedToLoadEvents: "فشل في تحميل الأحداث",
      inviteNewMember: "دعوة عضو جديد",
      enterFullName: "أدخل الاسم الكامل",
      relationship: "صلة القرابة",
      inviteSomeoneToCareCircle: "ادعُ شخصاً إلى دائرة رعايتك",
      tapToAddFamilyMembers: "اضغط هنا لإضافة أفراد العائلة وتتبع صحتهم.",
      trackFamilyHealth: "تتبع صحة العائلة",
      minAgo: "منذ {{count}} دقيقة",
      hoursAgoShort: "منذ {{count}} ساعة",
      daysAgoShort: "منذ {{count}} يوم",
      hoursAgo: "منذ {{count}} ساعة",
      daysAgo: "منذ {{count}} يوم",
      failedToExportReport: "فشل في تصدير التقرير",
      pleaseEnterReminderTimesFormat:
        "يرجى إدخال أوقات التذكير بالتنسيق الصحيح (مثال: 8:00)",
      title: "العنوان",
      eventType: "نوع الحدث",
      // Allergy conflict
      allergyConflictWarning: "⚠️ تحذير: تعارض مع الحساسية",
      medicationConflictMessage:
        "هذا الدواء قد يتعارض مع الحساسيات التالية: {{allergies}}",
      severeAllergyWarning: "تحذير: بعض هذه الحساسيات {{severity}}!",
      areYouSureProceed: "هل أنت متأكد من رغبتك في المتابعة؟",
      proceedAnyway: "المتابعة على أي حال",
      // Vitals/Health integration
      errorLoadingHealthData: "حدث خطأ في تحميل البيانات الصحية",
      healthDataIntegrationEnabled: "تم تفعيل دمج البيانات الصحية بنجاح",
      permissionDenied: "فشل التفعيل",
      pleaseAllowHealthDataAccess:
      ...
      healthKitNotAvailable: "HealthKit غير متاح",
      healthKitNotAvailableMessage: "HealthKit غير متاح.",
      healthKitError: "خطأ في HealthKit",
      installHealthConnect: "تثبيت Health Connect",
      openPlayStoreToInstall: "هل تريد فتح متجر Play لتثبيت Health Connect؟",
      open: "فتح",
      healthConnectError: "خطأ في Health Connect",
      enabled: "تم التفعيل",
      permissionError: "خطأ في أذن البيانات الصحية",
      errorSyncingHealthData: "حدث خطأ في مزامنة البيانات الصحية",
      // Medical history
      errorLoadingMedicalHistory: "حدث خطأ أثناء تحميل التاريخ الطبي",
      pleaseEnterMedicalCondition: "يرجى إدخال اسم الحالة الطبية",
      pleaseSelectFamilyMember: "يرجى اختيار عضو العائلة",
      medicalRecordAddedSuccessfully: "تم إضافة السجل الطبي بنجاح",
      failedToAddMedicalRecord: "حدث خطأ في إضافة السجل الطبي",
      deleteRecord: "حذف السجل",
      confirmDeleteMedicalRecord: "هل أنت متأكد من حذف هذا السجل الطبي؟",
      deleted: "تم الحذف",
      medicalRecordDeletedSuccessfully: "تم حذف السجل الطبي بنجاح",
      ...
      select: "اختر",
      healthDataIntegration: "دمج البيانات الصحية",
      setUpIntegration: "إعداد التكامل",
      healthVitalsIntegrations: "تكامل المؤشرات الحيوية",
      syncHealthVitals: "مزامنة المؤشرات الحيوية",
      failedToDeleteMedicalRecord: "حدث خطأ في حذف السجل الطبي",
      mustBeLoggedInFirst: "يجب تسجيل الدخول أولاً",
      pleaseEnterEventTitle: "يرجى إدخال عنوان الحدث",
      pleaseSelectStartDate: "يرجى اختيار تاريخ البداية",
      pleaseSelectValidEndDate: "يرجى اختيار تاريخ نهاية صحيح",
      reactNativeBridgeNotReady:
        "جسر React Native غير جاهز. يرجى المحاولة مرة أخرى بعد بضع ثوانٍ أو إعادة بناء التطبيق.",
      failedToConnectHealthKit: "فشل الاتصال بـ HealthKit.",
      failedToConnectHealthConnect: "فشل الاتصال بـ Health Connect.",
      failedToRequestHealthKitPermission: "فشل طلب أذن HealthKit.",
      failedToRequestHealthConnectPermission: "فشل طلب أذن Health Connect.",
      appointment: "موعد",
      ...
      clinicalIntegrations: "تكاملات سريرية",
      clinicIntegration: "العيادات",
      clinicIntegrationDesc:
        "ربط بوابات العيادات لزيارات الرعاية والأدوية وخطط العلاج",
      labIntegration: "المختبرات",
      labIntegrationDesc: "استيراد نتائج المختبر ونطاقات القيم مباشرة",
      radiologyIntegration: "الأشعة",
      radiologyIntegrationDesc: "مزامنة تقارير الأشعة وملفات PDF",
      integrationStatus: "حالة التكامل",
      integrationStatusNone: "لا توجد طلبات بعد",
      integrationStatusPending: "قيد المراجعة",
      integrationStatusApproved: "تمت الموافقة",
      integrationStatusRejected: "مطلوب معلومات إضافية",
      integrationStatusConnected: "متصل",
      integrationRequestTitle: "طلب تكامل",
      integrationRequestSubtitle:
        "سنتواصل مع المنشأة لتفعيل مشاركة البيانات بشكل آمن.",
      integrationProviderName: "اسم المزود",
      integrationPortalUrl: "رابط البوابة (اختياري)",
      integrationPatientId: "رقم المريض / السجل الطبي (اختياري)",
      integrationNotes: "ملاحظات (اختياري)",
      integrationSubmit: "إرسال الطلب",
      integrationSubmittedMessage:
        "تم استلام طلبك وسنتابع معك الخطوات التالية.",
      integrationMissingProviderName: "يرجى إدخال اسم المزود.",
      integrationNotSignedIn: "يجب تسجيل الدخول لطلب التكامل.",
      integrationRequestedOn: "تم الطلب في {{date}}",
      appleHealth: "Apple Health",
      ...
      syncNow: "مزامنة الآن",
      sync: "مزامنة",
      addTag: "أضف علامة (اضغط Enter)",
      suggestions: "اقتراحات",
      pendingSync: "عملية في الانتظار",
