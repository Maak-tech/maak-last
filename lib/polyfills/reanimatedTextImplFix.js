...
(function patchTextImplImmediately() {
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Legacy defensive polyfill needs broad compatibility checks.
  function patchTextImpl() {
    try {
      ...
      // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Compatibility predicate intentionally checks several React shapes.
      ...
      // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: Wrapper preserves static properties across multiple RN/React variants.
