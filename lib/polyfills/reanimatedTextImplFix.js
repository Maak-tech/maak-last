  ...
  function patchTextImpl() {
    ...
    function isForwardRefComponent(component) {
      ...
      try {
        ...
        if (component.render && component.render.$$typeof === React.forwardRef.$$typeof) return true;
        ...
        if (component.type && component.type.$$typeof === React.forwardRef.$$typeof) return true;
      } catch {
        return false;
      }
    ...
    function wrapWithForwardRef(component, displayName) {
      ...
      try {
        ...
        if (WrappedComponent) {
          WrappedComponent.displayName = displayName || (component && component.displayName) || (component && component.name) || 'WrappedComponent';
