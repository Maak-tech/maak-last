 ...
 * FHIR R4 Mappers
 *
 * Pure functions that convert Maak internal data to HL7 FHIR R4 resources.
...
/**
 * Map a Maak vital document to a FHIR R4 Observation.
 */
...
/**
 * Map a Maak medication document to a FHIR R4 MedicationRequest.
 */
...
/**
 * Map a Maak user document to a FHIR R4 Patient resource.
 */
export function userToPatient(
  ...
  return {
    resourceType: "Patient",
    id,
    identifier: [{ system: "urn:maak:patient", value: id }],
    name: fullName
      ? [
          {
            use: "official",
