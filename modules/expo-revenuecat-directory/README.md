...
RevenueCat SDK on iOS tries to cache data to a directory (`Documents/com.nuralix.app.revenuecat.etags/`) that may not exist yet, causing a non-critical error:
...
```
Documents/com.nuralix.app.revenuecat.etags/
```
